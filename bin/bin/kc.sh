...
#    kitty @ set-colors --configured ~/.config/kitty/kitty-themes/themes/Everforest_Light_Soft.conf
    ...
    printf "\n"
    echo "Available themes: alien, batman, cat, city, codex, duo, dumbledore, everforest-dark, 
        forest, gruvbox-dark, kaolin, lavandula, metal, monokai, neon,
         nova, seashells, seafoam, shaman, slate, spacedust, solar-dark, shadow,
